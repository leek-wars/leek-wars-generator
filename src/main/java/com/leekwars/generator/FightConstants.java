...
public enum FightConstants implements ILeekConstant {
	...
	FIGHT_TYPE_WAR(Fight.TYPE_WAR, Type.INT),
	FIGHT_TYPE_CHEST_HUNT(Fight.TYPE_CHEST_HUNT, Type.INT),
	FIGHT_TYPE_COLOSSUS(Fight.TYPE_COLOSSUS, Type.INT),
	...
	EROSION_POISON(Effect.EROSION_POISON, Type.REAL),
	EROSION_CRITICAL_MODIFIER(Effect.EROSION_CRITICAL_MODIFIER, Type.REAL),
