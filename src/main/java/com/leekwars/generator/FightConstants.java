...
public enum FightConstants implements ILeekConstant {
	...
	EFFECT_TARGET_ALWAYS_CASTER(0, LeekFunctions.INT),

	// Effect modifiers
	EFFECT_MODIFIER_STACKABLE(Effect.MODIFIER_STACKABLE, LeekFunctions.INT),
	EFFECT_MODIFIER_MULTIPLIED_BY_TARGETS(Effect.MODIFIER_MULTIPLIED_BY_TARGETS, LeekFunctions.INT),
	EFFECT_MODIFIER_ON_CASTER(Effect.MODIFIER_ON_CASTER, LeekFunctions.INT),
	EFFECT_MODIFIER_NOT_REPLACEABLE(Effect.MODIFIER_NOT_REPLACEABLE, LeekFunctions.INT),
	...
	EFFECT_STEAL_ABSOLUTE_SHIELD(Effect.TYPE_STEAL_ABSOLUTE_SHIELD, LeekFunctions.INT),
	EFFECT_NOVA_DAMAGE(Effect.TYPE_NOVA_DAMAGE, LeekFunctions.INT),
	EFFECT_RAW_BUFF_MP(Effect.TYPE_RAW_BUFF_MP, LeekFunctions.INT),
	EFFECT_RAW_BUFF_TP(Effect.TYPE_RAW_BUFF_TP, LeekFunctions.INT),
	EFFECT_POISON_TO_SCIENCE(Effect.TYPE_POISON_TO_SCIENCE, LeekFunctions.INT),
	EFFECT_DAMAGE_TO_ABSOLUTE_SHIELD(Effect.TYPE_DAMAGE_TO_ABSOLUTE_SHIELD, LeekFunctions.INT),
	EFFECT_DAMAGE_TO_STRENGTH(Effect.TYPE_DAMAGE_TO_STRENGTH, LeekFunctions.INT),
	EFFECT_NOVA_DAMAGE_TO_MAGIC(Effect.TYPE_NOVA_DAMAGE_TO_MAGIC, LeekFunctions.INT),
	EFFECT_RAW_ABSOLUTE_SHIELD(Effect.TYPE_RAW_ABSOLUTE_SHIELD, LeekFunctions.INT),
	EFFECT_RAW_BUFF_STRENGTH(Effect.TYPE_RAW_BUFF_STRENGTH, LeekFunctions.INT),
	...
	CHIP_WARM_UP(28, LeekFunctions.INT),
	CHIP_REFLEXES(27, LeekFunctions.INT),
	CHIP_LEATHER_BOOTS(14, LeekFunctions.INT),
	CHIP_WINGED_BOOTS(13, LeekFunctions.INT),
	CHIP_SEVEN_LEAGUE_BOOTS(12, LeekFunctions.INT),
	...
	CHIP_COVID(152, LeekFunctions.INT),
	CHIP_ELEVATION(154, LeekFunctions.INT),
	CHIP_KNOWLEDGE(155, LeekFunctions.INT),
	CHIP_WIZARDRY(156, LeekFunctions.INT),
