...
public class Leek extends Entity {
	...
	public Leek(Integer id, String name, int farmer, int level, int life, int turn_point, int move_point, int force, int agility, int frequency, int wisdom, int resistance, int science, int magic, int cores, int ram, int skin, boolean metal, int face, int team_id, String team_name, int ai_id, String ai_name, String farmer_name, String farmer_country, int hat) {
		super(id, name, farmer, level, life, turn_point, move_point, force, agility, frequency, wisdom, resistance, science, magic, cores, ram, skin, metal, face, team_id, team_name, ai_id, ai_name, farmer_name, farmer_country, hat);
	}
